"""
Django settings for insurance_aggregator project.
...
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    'django-insecure-5ecvo71mhr9@#3tj2*)+3+$xep49%5+-o(ns0+rvj!4h-00u_(',
)
...
ALLOWED_HOSTS = [host for host in default_hosts if host]
...
INSTALLED_APPS = [
    'insurance_aggregator.apps.InsuranceAggregatorConfig',
...
ROOT_URLCONF = 'insurance_aggregator.urls'
...
WSGI_APPLICATION = 'insurance_aggregator.wsgi.application'
